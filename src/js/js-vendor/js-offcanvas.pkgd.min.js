  ...
  (b.classes = {
    ...
    (b.a11yclick = function (a) {
      ...
      return (
        "click" === d ||
        ("keydown" === d &&
          (c === b.keyCodes.SPACE || c === b.keyCodes.ENTER || void 0))
      );
    }),
    ...
    (b.cssModifiers = function (a, c, d) {
      for (var e = a.split(","), f = 0, g = e.length; f < g; f++)
        c.push(b.createModifierClass(d, e[f].trim()));
    }),
    (b.getMetaOptions = function (a, b, c) {
      ...
      try {
        ...
        return void (
          console &&
          console.error("Error parsing " + d + " on " + a.className + ": " + g)
        );
      }
    }),
    (a.utils = b);
    ...
    (e.prototype.init = function () {
      ...
      (e.prototype.giveFocus = function () {
        ...
        d.length
          ? d.first().focus()
          : c
              .filter(b.focusableElementsString)
              .filter(":visible")
              .first()
              .focus();
      }),
      (e.prototype._trapTabKey = function (a, b) {
        ...
        if (9 == b.which) {
          ...
          (i = e.index(g)),
            b.shiftKey
              ? 0 == i && (e.get(h - 1).focus(), b.preventDefault())
              : i == h - 1 && (e.get(0).focus(), b.preventDefault());
        }
      }),
    ...
    (g.prototype.init = function () {
      ...
      (g.prototype._create = function () {
        ...
        (this._buttonClasses = [a.baseClass]),
          ...
          a.icon &&
            ((this.$buttonIcon = b(
              "<span class='" +
                a.iconFamily +
                " " +
                e.createModifierClass(a.iconFamily, a.icon) +
                "'></span>"
            ).prependTo(this.$element)),
            this._buttonClasses.push(
              e.createModifierClass(a.baseClass, f.withIcon)
            ),
            a.iconActive &&
              ((a.toggle = !0),
              (this.$buttonIconActive = b(
                "<span class='" +
                  a.iconFamily +
                  " " +
                  e.createModifierClass(a.iconFamily, a.iconActive) +
                  " " +
                  e.createModifierClass(a.iconFamily, f.showHide) +
                  "'></span>"
              ).insertAfter(this.$buttonIcon)),
              this._buttonClasses.push(
                e.createModifierClass(a.baseClass, f.toggleState)
              )),
            a.hideText &&
              (d.push(e.classes.hiddenVisually),
              this._buttonClasses.push(
                e.createModifierClass(a.baseClass, f.iconOnly)
              ))),
          a.modifiers &&
            e.cssModifiers(a.modifiers, this._buttonClasses, a.baseClass),
          ...
          a.textActive &&
            ...
            (this.$buttonTextActive = b("<span></span>")
              .addClass(d.join(" "))
              .html(a.textActive)
          ...
          a.expanded && ((this.isPressed = !0), this._isExpanded(a.expanded)),
          this.hasTitle ||
            !a.hideText ||
            a.hideTitle ||
      ...
      (g.prototype._isPressed = function (a) {
        (this.isPressed = a),
          this.$element
            .attr("aria-pressed", a)
            [a ? "addClass" : "removeClass"](e.classes.isActive);
      }),
      ...
      (g.prototype.destroy = function () {
        ...
        if (
          (this.$element
            ...
            .removeClass(e.classes.isActive)
            .off("." + c),
          this.options.icon &&
            this.$element
              .find('[class^="' + this.options.iconFamily + '"]')
              .remove(),
          a.wrapText)
        ) {
  ...
  (function (a, b) {
    ...
    (g.prototype.init = function () {
      ...
      (g.prototype._addAttributes = function () {
        var c = this.options,
          d = { tabindex: "-1", "aria-hidden": !this.isOpen };
        c.role && (d.role = c.role),
          (this._panelClasses = [c.baseClass, e.classes.isClosed]),
          a.utils.supportTransition ||
            this._panelClasses.push(
              e.createModifierClass(c.baseClass, c.supportNoTransitionsClass)
            ),
          ...
          e.cssModifiers(
            c.modifiers,
            this._bodyOpenClasses,
            c.bodyModifierClass
          ),
          c.modifiers.toLowerCase().indexOf("reveal") >= 0
      ...
      (g.prototype._closeButton = function () {
        ...
        (this.$closeBtn = this.$element.find("." + f.closeButtonClass)),
          this.$closeBtn.length &&
            ((this.closeBtn = new a.componentNamespace.Button(
              this.$closeBtn[0]
            )),
            this.closeBtn.init(),
      ...
      (g.prototype.open = function () {
        ...
        this.isOpen ||
          ...
          d.modal &&
            ...
            this.$modal.addClass(
              e.createModifierClass(d.modalClass, "opening")
            )),
          this.$element
            .attr("aria-hidden", "false")
            .addClass(e.createModifierClass(d.baseClass, "opening"))
            .trigger("opening." + c),
          ...
          e.onEndTransition(this.transitionElement, function () {
            a.trapTabKey.giveFocus(),
              ...
              d.modal &&
                (a._addClasses(a.$modal, a.isOpen, !1),
                a.$modal.removeClass(
                  e.createModifierClass(d.modalClass, "opening")
                )),
              a.$element.removeClass(
                e.createModifierClass(d.baseClass, "opening")
              );
          }),
          this.$trigger && this.$trigger.button._isExpanded(!0),
          this.onOpen &&
            "function" == typeof this.onOpen &&
      ...
      (g.prototype.close = function () {
        ...
        this.isOpen &&
          ...
          this.options.modal &&
            (this._addClasses(this.$modal, this.isOpen, !0),
            this.$modal.addClass(
              e.createModifierClass(g.modalClass, "closing")
            )),
          this.$element
            .attr("aria-hidden", "true")
            .addClass(e.createModifierClass(g.baseClass, "closing"))
            .trigger("closing." + c),
          ...
          e.onEndTransition(this.transitionElement, function () {
            d._addClasses(d.$element, d.isOpen, !1),
              ...
              d.options.modal &&
                (d._addClasses(d.$modal, d.isOpen, !1),
                d.$modal.removeClass(
                  e.createModifierClass(g.modalClass, "closing")
                )),
              d.$content.removeClass(d._contentOpenClasses.join(" ")),
              d.$element.removeClass(
                e.createModifierClass(g.baseClass, "closing")
              ),
      ...
      (g.prototype._addClasses = function (a, b, c) {
        b
          ? c
            ? a
                .removeClass(e.classes.isClosed)
                .addClass(e.classes.isAnimating)
                .addClass(e.classes.isOpen)
      ...
      (g.prototype._initTrigger = function () {
        ...
        d.triggerButton &&
          ((this.$triggerBtn = b(d.triggerButton)),
  ...
  (function (a, b) {
    ...
    (f.prototype.init = function () {
      ...
      (f.prototype._create = function () {
        if (
          ((this.options.offcanvas =
            this.options.offcanvas ||
            this.$element.attr("data-offcanvas-trigger")),
